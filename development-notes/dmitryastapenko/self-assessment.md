...
| **My Components**    | **Rich UI Screen:** Базовые UI компоненты (Демо-страница)                               | +20   | [PR #32](https://github.com/Blshop/JS-Practice-Hub/pull/32), [Components](https://github.com/Blshop/JS-Practice-Hub/tree/main/src/components), [Demo](https://github.com/Blshop/JS-Practice-Hub/tree/main/src/pages/Demo) |
| **Backend & Data**   | **Custom Backend:** Разработка API для прогресса пользователя (Node.js + Express)       | +30   | [Progress API](https://github.com/Blshop/JS-Practice-Hub/tree/main/server/src/controllers/progressController.js), [Model](https://github.com/Blshop/JS-Practice-Hub/tree/main/server/src/models/UserProgress.js)          |
...
| **UI & Interaction** | **Responsive:** Адаптивная верстка от 320px                                             | +5    | [Components SCSS](https://github.com/Blshop/JS-Practice-Hub/tree/main/src/components)                                                                                                                                     |
| **UI & Interaction** | **Accessibility (a11y):** Оптимизация доступности                                       | +10   | [Components](https://github.com/Blshop/JS-Practice-Hub/tree/main/src/components)                                                                                                                                          |
| **Quality**          | **Unit Tests (Basic):** Покрытие 20%+ личного кода                                      | +10   | [Tests](https://github.com/Blshop/JS-Practice-Hub/tree/main/src/components/__tests__)                                                                                                                                     |
| **Quality**          | **Unit Tests (Full):** Покрытие 50%+ личного кода                                       | +10   | [Весь проект](https://github.com/Blshop/JS-Practice-Hub/tree/main/src)                                                                                                                                                    |
| **Architecture**     | **State Manager:** MobX для управления состоянием                                       | +10   | [Stores](https://github.com/Blshop/JS-Practice-Hub/tree/main/src/store)                                                                                                                                                   |
| **Architecture**     | **Design Patterns:** Явное применение паттернов (Singleton, Observer, Strategy, Facade) | +10   | [UserProgressStore](https://github.com/Blshop/JS-Practice-Hub/blob/main/src/store/UserProgressStore.ts), [Services](https://github.com/Blshop/JS-Practice-Hub/tree/main/src/services)                                     |
| **Architecture**     | **API Layer:** Выделение слоя работы с API                                              | +10   | [Services](https://github.com/Blshop/JS-Practice-Hub/tree/main/src/services)                                                                                                                                              |
